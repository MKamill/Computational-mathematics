...
function w = x1_1(x1_0, x2_0, j)
    h = 0.5 //hhh!!!! изменить!!!!
    w = x1_0 - h*df_x1(x1_0, x2_0) 
endfunction

function w = x2_1(x1_0, x2_0, j)
    h = 0.5 //hhh!!!! изменить!!!!
...
function proc(x1_0, x2_0)
    ...
    if f(x1_0,x2_0) > f(x1_1(x1_0,x2_0, 0.5),x2_1(x1_0,x2_0, 0.5)) then
     ...
     disp('делим шаг пополам' + 'f('+string(x1_0)+','+string(x2_0)+')=<'+'f('+string(x1_1(x1_0,x2_0, 0.5))+','+string(x2_1(x1_0,x2_0, 0.5))+')')
    end
